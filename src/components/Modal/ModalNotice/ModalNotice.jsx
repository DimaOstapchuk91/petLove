...
const ModalNotice = ({ id }) => {
  ...
  return (
    <div className='w-full max-w-[335px] px-7 py-10 bg-text-white  rounded-[30px] flex flex-col justify-center'>
      <div className='relative mb-5 m-auto'>
        <p className='absolute left-0 top-0 px-3.5 py-2 bg-brand-light rounded-[30px] text-brand font-medium text-sm leading-4 -tracking-[0.24px]'>
          {category}
        </p>
        <img
      ...
      <h3 className=' font-bold leading-5 mb-2.5 text-center'>{title}</h3>
      ...
      <p className='text-center font-bold leading-5 mb-5'>${price}</p>
      <div className='w-full flex gap-2.5'>
        <button
          className='group flex justify-center gap-2 w-full max-w-1/2 rounded-full p-3 bg-brand text-text-white cursor-pointer'
          type='button'
        ...
        >
          ...
          <svg
            className={
              isFavorite
                ? 'group-hover:fill-hover fill-text-white stroke-text-white'
                : 'group-hover:fill-text-white fill-transparent stroke-text-white'
            }
            width='18'
            height='18'
          >
